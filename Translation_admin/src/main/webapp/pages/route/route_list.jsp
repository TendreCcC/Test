                    ...
                    <div class="box-body">
                         <div class="form-group">
                            <div class="col-md-6" style="padding-left: 0px;">
                                <input type="text" class="form-control" id="rname" name="rname" placeholder="请输入线路名字" value="${rname}">
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="row">
                            <form action="#" method="post" id="listForm">
                                <table id="example2" class="table table-bordered table-hover dataTable"
                                    ...
                                    <tbody>
                                    <c:forEach items="${PageBean.list}" var="route" varStatus="row">
                                    <tr role="row">
                                        <td class=""><input type="checkbox" name="rid" value="${route.rid}"></td>
                                        <td class="sorting_1">${(PageBean.pageNum - 1) * PageBean.size + row.count} </td>
                                        <td><img
                                                src="${route.rimage}"
                                                width="99px"></td>
                                        <td>"${route.rname}"</td>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="dataTables_info" id="example2_info" role="status"
                                     aria-live="polite">共${PageBean.pages}页，共${PageBean.total}条
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                                    <ul class="pagination" style="margin: 0px">
                                        <li class="paginate_button previous" id="example2_firsts"><a
                                                href="/route?action=listByPage&page=1&rname=${rname}" aria-controls="example2" data-dt-idx="0" tabindex="0">首页</a>
                                        </li>
                                        <li class="paginate_button previous" id="example2_previous"><a
                                                href="/route?action=listByPage&page=${PageBean.prePage}&rname=${rname}" aria-controls="example2" data-dt-idx="0" tabindex="0">上一页</a>
                                        </li>
                                       <c:forEach var="num" begin="${PageBean.navigateFirstPage}" end="${PageBean.navigateLastPage}">

                                            <li class="paginate_button ${num==PageBean.pageNum?'active':''}">
                                            <a href="/route?action=listByPage&page=${num}&rname=${rname}" aria-controls="example2"  tabindex="0">${num}</a>
                                        </li>
                                        </c:forEach>

                                        <li class="paginate_button next" id="example2_next">
                                            <a href="/route?action=listByPage&page=${PageBean.nextPage}&rname=${rname}" aria-controls="example2" data-dt-idx="7" tabindex="0">下一页</a>
                                        </li>
                                        <li class="paginate_button next" id="example2_last">
                                            <a href="/route?action=listByPage&page=${PageBean.pages}&rname=${rname}" aria-controls="example2" data-dt-idx="7" tabindex="0">尾页</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
